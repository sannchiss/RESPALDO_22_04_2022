...
class ReportsController extends Controller
{
    ...
    {   
        ...
        return view('reports.documents.index',['date_start' => $date_start, 'date_end' => $date_end]);

        if(!$request->ajax()){
           return view('reports.documents.index', [
    ...
    public function document(Request $request)
    {
      ...
      return DataTables::of($documents)
        ...
        {
            return Excel::download(new DocumentExport($date_start,$date_end),'Document.xlsx');
