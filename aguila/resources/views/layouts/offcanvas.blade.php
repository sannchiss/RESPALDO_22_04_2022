...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-dark bg-dark navbar-laravel">
            <div class="container-fluid">
                ...
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="{{ asset('img/prisa.png') }}" height="40" > {{ config('app.name', 'Laravel') }}
                </a>
        ...
        <main id='main-canvas' class="container-fluid" style="width: calc(100% - 82px); margin-left: 82px;">
            <div class="py-4">
                @yield('content')
            </div>
        </main>
        <nav id="offcanvas" class="">
            <div class="py-4">
                @yield('offcanvas-content')
            </div>
        </nav>
    </div>
