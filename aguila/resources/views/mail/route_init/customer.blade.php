...
​
	 <tr>
	  <th >
	  	...
	  	<table class="message">
		  	<tr>
				<th class="left">Estimado, {{$info->customer_name}} </th>
			</tr>
	  	</table>
	  	<table class="message">
		  	<tr>
				<th class="left">Por medio del presente le notificamos que la(s) siguientes faturas seran despachada(s) el día de hoy <strong> {{date('Y-m-d')}} </strong> en su domicilio registrado <strong>{{$info->customer_address}}</strong> </th>.
			</tr>
	  	</table>
​
	  	<!--fin Encabezado -->
