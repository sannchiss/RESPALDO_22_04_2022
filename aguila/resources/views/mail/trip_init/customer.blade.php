...
<body>
	...
	<tr>
	  <th>
	  <!-- Logo -->
	  <img src='{{ asset("img/companies/{$customer->office_code}.jpg") }}' height="90">	
	  </th>
	 </tr>
​
	 <tr>
...
​
	 <tr>
	  <th >
	  	...
	  	<table class="message">
		  	<tr>
				<th class="left">Estimado, {{$customer->customer_name}} </th>
			</tr>
	  	</table>
	  	<table class="message">
		  	<tr>
				<th class="left">Estimado cliente su depacho esta proximo ha ser entregado en su domicilio registrado <strong>{{$customer->customer_address}}</strong></th>
			</tr>
			<tr>
				<th class="left">Las siguientes pedidos seran entregadas: {{$customer->document_order_number}}</strong></th>
			</tr>
			<tr>
				<th class="left">Facturas o guias asociadas: {{$customer->document_code}}</strong></th>
			</tr>
	  	</table>
​
	  	<!--fin Encabezado -->
	 ...
	 <tr>
	  ...
	  <!-- open cotizacion -->
	  	<table class="close">
	  		<tr>
		  		<th>
		  			<h4>GRACIAS POR PREFEREIRNOS ... </h4>
		  		</th>
	 			</tr>
	  	</table>
