				 ...
				 <div class="card-body">
					<form>
						<div class="form-row">
							...
							<div class="form-group mx-sm-3 mb-1">
									<br>
									<a class="btn btn-success " href="{{ route('reports.documents.export',[$date_start,$date_end]) }}" download>Exportar Excel<i class="fas fa-file-excel"></i></a>
							</div>	
						</div>
					</form>
				</div>
...
@include('reports.documents.documents')
...
$(document).ready(function() {
	...
	var params = { 
				...
				processing: true,
				serverSide: true,
                ajax: "{{ route('reports.documents.document') }}?" + $.param(params),
                pageLength: 20,
	            language: {
	                "url": dtLanguage,
	            },
