...
INSERT INTO public.statuses (id, system_area_id, code, label, icon, color, created_at, updated_at) VALUES (2, 2, 'PENDING_DEPARTURE', 'Pendiente por Salida', NULL, NULL, '2018-09-07 16:00:14', '2018-09-07 16:00:14');
...
INSERT INTO public.statuses (id, system_area_id, code, label, icon, color, created_at, updated_at) VALUES (5, 3, 'PENDING_DEPARTURE', 'Pendiente por Salida', NULL, 'secondary', '2018-09-07 16:00:14', '2018-09-07 16:00:14');
...
INSERT INTO public.statuses (id, system_area_id, code, label, icon, color, created_at, updated_at) VALUES (7, 4, 'PENDING_DEPARTURE', 'Pendiente por Salida', NULL, NULL, '2018-09-07 16:00:14', '2018-09-07 16:00:14');
...
SELECT pg_catalog.setval('public.statuses_id_seq', 21, true);
...
SELECT pg_catalog.setval('public.system_areas_id_seq', 5, true);
