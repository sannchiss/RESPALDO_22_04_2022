    ...
    <div class="modal-dialog modal-dialog-scrollable modal-xl">
        <div class="modal-content">
                            ...
                            <div class="card bg-light mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" placeholder=""
                                                id="phoneNumberRecipient" name="phoneNumberRecipient" readonly>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="email" class="form-control" placeholder=""
                                                id="vatNumberRecipient" name="vatNumberRecipient" readonly>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-floating mb-3">
                                            <textarea class="form-control" placeholder="" id="notesRecipient" rows="3" cols="20"
                                                name="notesRecipient" readonly ></textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" placeholder="" id="cityRecipient"
                                                name="cityRecipient" readonly>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" placeholder=""
                                                id="streetLine1Recipient" name="streetLine1Recipient" value="">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" placeholder=""
                                                id="streetLine2Recipient" name="streetLine2Recipient" value="">
                                ...
                                <div class="card bg-light mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" placeholder=""
                                                    id="numberOfPieces" name="numberOfPieces" value="">
                                ...
                                <div class="accordion accordion-flush" id="accordionFlushExample">
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="flush-headingOne">
                                            <button class="accordion-button collapsed bg-secondary bg-gradient py-3"
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="form-floating mb-3">
                                                                            <input type="text" class="form-control"
                                                                                ...
                                                                                aria-label="Floating label example input">
                                                                            <label for="addressLine1Shipper">Address
                                                                                Line 1</label>
                                                                        </div>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary click">Generar Envío</button>
            </div>
        </div>
    </div>
</div>