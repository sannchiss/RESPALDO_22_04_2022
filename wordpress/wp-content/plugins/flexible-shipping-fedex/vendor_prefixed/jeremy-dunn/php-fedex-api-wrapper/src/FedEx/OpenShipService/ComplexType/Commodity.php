 ...
 * @property \FedEx\OpenShipService\SimpleType\CommodityPurposeType|string $Purpose
...
class Commodity extends \FedExVendor\FedEx\AbstractComplexType
{
     ...
     * Set Purpose
     *
     * @param \FedEx\OpenShipService\SimpleType\CommodityPurposeType|string $purpose
     * @return $this
     */
     ...
     * @return $this
     */
    public function setUnitPrice(\FedExVendor\FedEx\OpenShipService\ComplexType\Money $unitPrice)
    {
     ...
     * @return $this
     */
    public function setNaftaDetail(\FedExVendor\FedEx\OpenShipService\ComplexType\NaftaCommodityDetail $naftaDetail)
    {
