...
class CompletedShipmentDetail extends \FedExVendor\FedEx\AbstractComplexType
{
     ...
     * @return $this
     */
    public function setServiceDescription(\FedExVendor\FedEx\OpenShipService\ComplexType\ServiceDescription $serviceDescription)
    {
     ...
     * @return $this
     */
    public function setOperationalDetail(\FedExVendor\FedEx\OpenShipService\ComplexType\ShipmentOperationalDetail $operationalDetail)
    {
     ...
     * @return $this
     */
    public function setAccessDetail(\FedExVendor\FedEx\OpenShipService\ComplexType\PendingShipmentAccessDetail $accessDetail)
    {
     ...
     * @return $this
     */
    public function setTagDetail(\FedExVendor\FedEx\OpenShipService\ComplexType\CompletedTagDetail $tagDetail)
    {
     ...
     * @return $this
     */
    public function setSmartPostDetail(\FedExVendor\FedEx\OpenShipService\ComplexType\CompletedSmartPostDetail $smartPostDetail)
    {
     ...
     * @return $this
     */
    public function setHazardousShipmentDetail(\FedExVendor\FedEx\OpenShipService\ComplexType\CompletedHazardousShipmentDetail $hazardousShipmentDetail)
    {
     ...
     * @return $this
     */
    public function setShipmentRating(\FedExVendor\FedEx\OpenShipService\ComplexType\ShipmentRating $shipmentRating)
    {
     ...
     * @return $this
     */
    public function setConsolidationDetail(\FedExVendor\FedEx\OpenShipService\ComplexType\CompletedShipmentConsolidationDetail $consolidationDetail)
    {
     ...
     * @return $this
     */
    public function setCompletedHoldAtLocationDetail(\FedExVendor\FedEx\OpenShipService\ComplexType\CompletedHoldAtLocationDetail $completedHoldAtLocationDetail)
    {
     ...
     * @return $this
     */
    public function setDocumentRequirements(\FedExVendor\FedEx\OpenShipService\ComplexType\DocumentRequirementsDetail $documentRequirements)
    {
     ...
     * @return $this
     */
    public function setCompletedEtdDetail(\FedExVendor\FedEx\OpenShipService\ComplexType\CompletedEtdDetail $completedEtdDetail)
    {
     ...
     * @return $this
     */
    public function setCompletedCodDetail(\FedExVendor\FedEx\OpenShipService\ComplexType\CompletedCodDetail $completedCodDetail)
    {
