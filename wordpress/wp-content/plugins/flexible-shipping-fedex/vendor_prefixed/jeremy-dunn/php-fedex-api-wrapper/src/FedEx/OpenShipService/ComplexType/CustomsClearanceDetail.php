 ...
 * @property \FedEx\OpenShipService\SimpleType\ClearanceBrokerageType|string $ClearanceBrokerage
 ...
 * @property \FedEx\OpenShipService\SimpleType\InternationalDocumentContentType|string $DocumentContent
 * @property Money $CustomsValue
 * @property \FedEx\OpenShipService\SimpleType\FreightOnValueType|string $FreightOnValue
 ...
 * @property \FedEx\OpenShipService\SimpleType\RegulatoryControlType|string[] $RegulatoryControls
...
class CustomsClearanceDetail extends \FedExVendor\FedEx\AbstractComplexType
{
     ...
     *
     * @param \FedEx\OpenShipService\SimpleType\ClearanceBrokerageType|string $clearanceBrokerage
     * @return $this
     */
     ...
     * @return $this
     */
    public function setCustomsOptions(\FedExVendor\FedEx\OpenShipService\ComplexType\CustomsOptionDetail $customsOptions)
    {
     ...
     * @return $this
     */
    public function setImporterOfRecord(\FedExVendor\FedEx\OpenShipService\ComplexType\Party $importerOfRecord)
    {
     ...
     * @return $this
     */
    public function setRecipientCustomsId(\FedExVendor\FedEx\OpenShipService\ComplexType\RecipientCustomsId $recipientCustomsId)
    {
     ...
     * @return $this
     */
    public function setDutiesPayment(\FedExVendor\FedEx\OpenShipService\ComplexType\Payment $dutiesPayment)
    {
     ...
     * Set DocumentContent
     *
     * @param \FedEx\OpenShipService\SimpleType\InternationalDocumentContentType|string $documentContent
     * @return $this
     */
     ...
     * @return $this
     */
    public function setCustomsValue(\FedExVendor\FedEx\OpenShipService\ComplexType\Money $customsValue)
    {
     ...
     *
     * @param \FedEx\OpenShipService\SimpleType\FreightOnValueType|string $freightOnValue
     * @return $this
     */
     ...
     * @return $this
     */
    public function setInsuranceCharges(\FedExVendor\FedEx\OpenShipService\ComplexType\Money $insuranceCharges)
    {
     ...
     * @return $this
     */
    public function setCommercialInvoice(\FedExVendor\FedEx\OpenShipService\ComplexType\CommercialInvoice $commercialInvoice)
    {
     ...
     * @return $this
     */
    public function setExportDetail(\FedExVendor\FedEx\OpenShipService\ComplexType\ExportDetail $exportDetail)
    {
     ...
     *
     * @param \FedEx\OpenShipService\SimpleType\RegulatoryControlType[]|string[] $regulatoryControls
     * @return $this
     */
     ...
     * @return $this
     */
    public function setDeclarationStatementDetail(\FedExVendor\FedEx\OpenShipService\ComplexType\CustomsDeclarationStatementDetail $declarationStatementDetail)
    {
