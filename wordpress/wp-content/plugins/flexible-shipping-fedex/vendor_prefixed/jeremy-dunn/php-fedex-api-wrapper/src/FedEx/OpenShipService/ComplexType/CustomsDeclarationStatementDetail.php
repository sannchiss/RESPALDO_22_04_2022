...
class CustomsDeclarationStatementDetail extends \FedExVendor\FedEx\AbstractComplexType
{
     ...
     * @return $this
     */
    public function setNaftaLowValueStatementDetail(\FedExVendor\FedEx\OpenShipService\ComplexType\NaftaLowValueStatementDetail $naftaLowValueStatementDetail)
    {
