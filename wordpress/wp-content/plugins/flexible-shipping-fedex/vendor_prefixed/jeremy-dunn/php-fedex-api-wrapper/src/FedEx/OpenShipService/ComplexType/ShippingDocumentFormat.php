 ...
 * @property \FedEx\OpenShipService\SimpleType\ShippingDocumentStockType|string $StockType
...
class ShippingDocumentFormat extends \FedExVendor\FedEx\AbstractComplexType
{
     ...
     * @return $this
     */
    public function setTopOfPageOffset(\FedExVendor\FedEx\OpenShipService\ComplexType\LinearMeasure $topOfPageOffset)
    {
     ...
     * Set StockType
     *
     * @param \FedEx\OpenShipService\SimpleType\ShippingDocumentStockType|string $stockType
     * @return $this
     */
     ...
     * @return $this
     */
    public function setOptionsRequested(\FedExVendor\FedEx\OpenShipService\ComplexType\DocumentFormatOptionsRequested $optionsRequested)
    {
