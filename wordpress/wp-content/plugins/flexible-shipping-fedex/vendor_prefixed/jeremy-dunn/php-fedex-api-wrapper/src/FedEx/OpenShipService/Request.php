...
class Request extends \FedExVendor\FedEx\AbstractRequest
{
     ...
     * @return ComplexType\CreateOpenShipmentReply|stdClass
     */
    public function getCreatePendingShipmentReply(\FedExVendor\FedEx\OpenShipService\ComplexType\CreateOpenShipmentRequest $createOpenShipmentRequest, $returnStdClass = \false)
    {
