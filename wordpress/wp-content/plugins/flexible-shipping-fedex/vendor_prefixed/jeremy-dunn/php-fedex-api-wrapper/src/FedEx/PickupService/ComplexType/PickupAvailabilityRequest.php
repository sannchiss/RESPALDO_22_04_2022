...
class PickupAvailabilityRequest extends \FedExVendor\FedEx\AbstractComplexType
{
     ...
     * @return $this
     */
    public function setAccountNumber(\FedExVendor\FedEx\PickupService\ComplexType\AssociatedAccount $accountNumber)
    {
     ...
     * @return $this
     */
    public function setPickupAddress(\FedExVendor\FedEx\PickupService\ComplexType\Address $pickupAddress)
    {
     ...
     * @return $this
     */
    public function setShipmentAttributes(\FedExVendor\FedEx\PickupService\ComplexType\PickupShipmentAttributes $shipmentAttributes)
    {
