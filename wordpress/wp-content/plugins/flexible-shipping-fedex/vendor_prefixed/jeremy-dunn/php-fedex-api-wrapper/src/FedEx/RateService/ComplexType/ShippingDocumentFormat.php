...
class ShippingDocumentFormat extends \FedExVendor\FedEx\AbstractComplexType
{
     ...
     * @return $this
     */
    public function setTopOfPageOffset(\FedExVendor\FedEx\RateService\ComplexType\LinearMeasure $topOfPageOffset)
    {
     ...
     * @return $this
     */
    public function setOptionsRequested(\FedExVendor\FedEx\RateService\ComplexType\DocumentFormatOptionsRequested $optionsRequested)
    {
