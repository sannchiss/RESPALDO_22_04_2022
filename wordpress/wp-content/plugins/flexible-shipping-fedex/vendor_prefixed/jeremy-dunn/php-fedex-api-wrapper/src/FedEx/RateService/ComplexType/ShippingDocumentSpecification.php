...
class ShippingDocumentSpecification extends \FedExVendor\FedEx\AbstractComplexType
{
     ...
     * @return $this
     */
    public function setNaftaCertificateOfOriginDetail(\FedExVendor\FedEx\RateService\ComplexType\NaftaCertificateOfOriginDetail $naftaCertificateOfOriginDetail)
    {
