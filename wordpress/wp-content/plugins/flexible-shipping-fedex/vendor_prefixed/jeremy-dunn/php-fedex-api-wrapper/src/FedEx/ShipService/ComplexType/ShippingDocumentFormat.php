 ...
 * @property \FedEx\ShipService\SimpleType\ShippingDocumentStockType|string $StockType
...
class ShippingDocumentFormat extends \FedExVendor\FedEx\AbstractComplexType
{
     ...
     * @return $this
     */
    public function setTopOfPageOffset(\FedExVendor\FedEx\ShipService\ComplexType\LinearMeasure $topOfPageOffset)
    {
     ...
     * @return $this
     */
    public function setOptionsRequested(\FedExVendor\FedEx\ShipService\ComplexType\DocumentFormatOptionsRequested $optionsRequested)
    {
