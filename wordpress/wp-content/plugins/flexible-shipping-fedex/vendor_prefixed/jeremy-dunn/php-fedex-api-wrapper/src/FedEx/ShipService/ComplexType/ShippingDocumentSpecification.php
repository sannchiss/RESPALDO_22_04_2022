...
class ShippingDocumentSpecification extends \FedExVendor\FedEx\AbstractComplexType
{
     ...
     * @return $this
     */
    public function setNaftaCertificateOfOriginDetail(\FedExVendor\FedEx\ShipService\ComplexType\NaftaCertificateOfOriginDetail $naftaCertificateOfOriginDetail)
    {
