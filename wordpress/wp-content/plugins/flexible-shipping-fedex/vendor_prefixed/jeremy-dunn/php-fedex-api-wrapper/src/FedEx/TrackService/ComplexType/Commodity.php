 ...
 * @property \FedEx\TrackService\SimpleType\CommodityPurposeType|string $Purpose
...
class Commodity extends \FedExVendor\FedEx\AbstractComplexType
{
     ...
     * Set Purpose
     *
     * @param \FedEx\TrackService\SimpleType\CommodityPurposeType|string $purpose
     * @return $this
     */
     ...
     * @return $this
     */
    public function setWeight(\FedExVendor\FedEx\TrackService\ComplexType\Weight $weight)
    {
     ...
     * @return $this
     */
    public function setUnitPrice(\FedExVendor\FedEx\TrackService\ComplexType\Money $unitPrice)
    {
     ...
     * @return $this
     */
    public function setCustomsValue(\FedExVendor\FedEx\TrackService\ComplexType\Money $customsValue)
    {
     ...
     * @return $this
     */
    public function setNaftaDetail(\FedExVendor\FedEx\TrackService\ComplexType\NaftaCommodityDetail $naftaDetail)
    {
