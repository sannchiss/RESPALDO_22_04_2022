...
class CustomsDeclarationStatementDetail extends \FedExVendor\FedEx\AbstractComplexType
{
     ...
     * @return $this
     */
    public function setNaftaLowValueStatementDetail(\FedExVendor\FedEx\ValidationAvailabilityAndCommitmentService\ComplexType\NaftaLowValueStatementDetail $naftaLowValueStatementDetail)
    {
