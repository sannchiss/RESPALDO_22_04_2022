 ...
 * @property \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\PhysicalPackagingType|string $Packaging
 * @property int $Pieces
 * @property string $NmfcCode
 * @property \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\HazardousCommodityOptionType|string $HazardousMaterials
...
class FreightShipmentLineItem extends \FedExVendor\FedEx\AbstractComplexType
{
     ...
     *
     * @param \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\FreightClassType|string $freightClass
     * @return $this
     */
     ...
     * @return $this
     */
    public function setLiabilityCoverageDetail(\FedExVendor\FedEx\ValidationAvailabilityAndCommitmentService\ComplexType\LiabilityCoverageDetail $liabilityCoverageDetail)
    {
     ...
     *
     * @param \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\PhysicalPackagingType|string $packaging
     * @return $this
     */
     ...
     *
     * @param \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\HazardousCommodityOptionType|string $hazardousMaterials
     * @return $this
     */
     ...
     * @return $this
     */
    public function setVolume(\FedExVendor\FedEx\ValidationAvailabilityAndCommitmentService\ComplexType\Volume $volume)
    {
