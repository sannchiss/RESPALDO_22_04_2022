...
class RequestedPackageLineItem extends \FedExVendor\FedEx\AbstractComplexType
{
     ...
     * @return $this
     */
    public function setStatusDetail(\FedExVendor\FedEx\ValidationAvailabilityAndCommitmentService\ComplexType\PackageStatusDetail $statusDetail)
    {
     ...
     * @return $this
     */
    public function setVariableHandlingChargeDetail(\FedExVendor\FedEx\ValidationAvailabilityAndCommitmentService\ComplexType\VariableHandlingChargeDetail $variableHandlingChargeDetail)
    {
     ...
     * @return $this
     */
    public function setInsuredValue(\FedExVendor\FedEx\ValidationAvailabilityAndCommitmentService\ComplexType\Money $insuredValue)
    {
     ...
     * @return $this
     */
    public function setDimensions(\FedExVendor\FedEx\ValidationAvailabilityAndCommitmentService\ComplexType\Dimensions $dimensions)
    {
     ...
     * @return $this
     */
    public function setSpecialServicesRequested(\FedExVendor\FedEx\ValidationAvailabilityAndCommitmentService\ComplexType\PackageSpecialServicesRequested $specialServicesRequested)
    {
     ...
     * @return $this
     */
    public function setSpecialHandlingDetail(\FedExVendor\FedEx\ValidationAvailabilityAndCommitmentService\ComplexType\PackageSpecialHandlingDetail $specialHandlingDetail)
    {
     ...
     * @return $this
     */
    public function setConveyanceDetail(\FedExVendor\FedEx\ValidationAvailabilityAndCommitmentService\ComplexType\ShipperConveyanceDetail $conveyanceDetail)
    {
