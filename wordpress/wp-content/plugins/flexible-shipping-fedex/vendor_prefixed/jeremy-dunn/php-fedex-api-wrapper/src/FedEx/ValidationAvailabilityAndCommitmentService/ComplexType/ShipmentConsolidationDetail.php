 ...
 * @property \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\ConsolidationType|string $Type
 * @property \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\ConsolidationShipmentRoleType|string $Role
 ...
 * @property Address $ConsolidationOriginAddress
...
class ShipmentConsolidationDetail extends \FedExVendor\FedEx\AbstractComplexType
{
     ...
     *
     * @param \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\ConsolidationType|string $type
     * @return $this
     */
     ...
     *
     * @param \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\ConsolidationShipmentRoleType|string $role
     * @return $this
     */
     ...
     * @return $this
     */
    public function setSpecialServicesRequested(\FedExVendor\FedEx\ValidationAvailabilityAndCommitmentService\ComplexType\ConsolidationSpecialServicesRequested $specialServicesRequested)
    {
        $this->values['SpecialServicesRequested'] = $specialServicesRequested;
        return $this;
    }
    /**
     * This is the origin address of the consolidation.
     *
     * @param Address $consolidationOriginAddress
     * @return $this
     */
    public function setConsolidationOriginAddress(\FedExVendor\FedEx\ValidationAvailabilityAndCommitmentService\ComplexType\Address $consolidationOriginAddress)
    {
     ...
     * @return $this
     */
    public function setInternationalDistributionDetail(\FedExVendor\FedEx\ValidationAvailabilityAndCommitmentService\ComplexType\ShipmentInternationalDistributionDetail $internationalDistributionDetail)
    {
     ...
     * @return $this
     */
    public function setTransborderDistributionDetail(\FedExVendor\FedEx\ValidationAvailabilityAndCommitmentService\ComplexType\ShipmentTransborderDistributionDetail $transborderDistributionDetail)
    {
