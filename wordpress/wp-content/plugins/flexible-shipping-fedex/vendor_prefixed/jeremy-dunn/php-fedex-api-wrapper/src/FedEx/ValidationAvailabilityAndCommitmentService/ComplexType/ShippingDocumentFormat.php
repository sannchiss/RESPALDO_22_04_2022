 ...
 * @property \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\ShippingDocumentStockType|string $StockType
...
class ShippingDocumentFormat extends \FedExVendor\FedEx\AbstractComplexType
{
     ...
     * @return $this
     */
    public function setTopOfPageOffset(\FedExVendor\FedEx\ValidationAvailabilityAndCommitmentService\ComplexType\LinearMeasure $topOfPageOffset)
    {
     ...
     * Set StockType
     *
     * @param \FedEx\ValidationAvailabilityAndCommitmentService\SimpleType\ShippingDocumentStockType|string $stockType
     * @return $this
     */
     ...
     * @return $this
     */
    public function setOptionsRequested(\FedExVendor\FedEx\ValidationAvailabilityAndCommitmentService\ComplexType\DocumentFormatOptionsRequested $optionsRequested)
    {
