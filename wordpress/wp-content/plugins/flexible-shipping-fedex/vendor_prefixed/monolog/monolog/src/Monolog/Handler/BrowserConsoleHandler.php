 ...
 */
class BrowserConsoleHandler extends \FedExVendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return new \FedExVendor\Monolog\Formatter\LineFormatter('[[%channel%]]{macro: autolabel} [[%level_name%]]{font-weight: bold} %message%');
    }
    /**
     * {@inheritDoc}
     */
