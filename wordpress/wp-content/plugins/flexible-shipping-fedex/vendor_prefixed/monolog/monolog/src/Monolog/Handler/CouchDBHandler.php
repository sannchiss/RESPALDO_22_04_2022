 ...
 */
class CouchDBHandler extends \FedExVendor\Monolog\Handler\AbstractProcessingHandler
{
    private $options;
    public function __construct(array $options = array(), $level = \FedExVendor\Monolog\Logger::DEBUG, $bubble = \true)
    {
