...
use FedExVendor\Monolog\Formatter\WildfireFormatter;
/**
 * Simple FirePHP Handler (http://www.firephp.org/), which uses the Wildfire protocol.
 *
 * @author Eric Clemmons (@ericclemmons) <eric@uxdriven.com>
 */
class FirePHPHandler extends \FedExVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
    ...
    {
        return new \FedExVendor\Monolog\Formatter\WildfireFormatter();
    }
    /**
