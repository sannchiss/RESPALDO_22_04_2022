 ...
 */
class PushoverHandler extends \FedExVendor\Monolog\Handler\SocketHandler
{
    private $token;
    private $users;
    private $title;
     ...
     */
    public function __construct($token, $users, $title = null, $level = \FedExVendor\Monolog\Logger::CRITICAL, $bubble = \true, $useSSL = \true, $highPriorityLevel = \FedExVendor\Monolog\Logger::CRITICAL, $emergencyLevel = \FedExVendor\Monolog\Logger::EMERGENCY, $retry = 30, $expire = 25200)
    {
        ...
        $this->highPriorityLevel = \FedExVendor\Monolog\Logger::toMonologLevel($highPriorityLevel);
        $this->emergencyLevel = \FedExVendor\Monolog\Logger::toMonologLevel($emergencyLevel);
        $this->retry = $retry;
        $this->expire = $expire;
    }
