...
use FedExVendor\RollbarNotifier;
use Exception;
...
class RollbarHandler extends \FedExVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct(\FedExVendor\RollbarNotifier $rollbarNotifier, $level = \FedExVendor\Monolog\Logger::ERROR, $bubble = \true)
    {
