 ...
 */
class RotatingFileHandler extends \FedExVendor\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct($filename, $maxFiles = 0, $level = \FedExVendor\Monolog\Logger::DEBUG, $bubble = \true, $filePermission = null, $useLocking = \false)
    {
        $this->filename = \FedExVendor\Monolog\Utils::canonicalizePath($filename);
