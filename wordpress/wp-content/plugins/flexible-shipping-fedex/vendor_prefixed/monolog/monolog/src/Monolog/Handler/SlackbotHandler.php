 ...
 */
class SlackbotHandler extends \FedExVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($slackTeam, $token, $channel, $level = \FedExVendor\Monolog\Logger::CRITICAL, $bubble = \true)
    {
