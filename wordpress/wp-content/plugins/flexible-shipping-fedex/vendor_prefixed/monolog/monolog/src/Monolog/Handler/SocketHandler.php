 ...
 */
class SocketHandler extends \FedExVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($connectionString, $level = \FedExVendor\Monolog\Logger::DEBUG, $bubble = \true)
    {
