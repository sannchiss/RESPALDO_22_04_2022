...
if (!\interface_exists('FedExVendor\\WPDesk_Translatable')) {
    require_once __DIR__ . '/Translatable.php';
}
if (!\interface_exists('FedExVendor\\WPDesk_Buildable')) {
    require_once __DIR__ . '/Buildable.php';
}
if (!\interface_exists('FedExVendor\\WPDesk_Has_Plugin_Info')) {
 ...
 */
class WPDesk_Plugin_Info implements \FedExVendor\WPDesk_Translatable, \FedExVendor\WPDesk_Buildable, \FedExVendor\WPDesk_Has_Plugin_Info
{
    /** @var string */
