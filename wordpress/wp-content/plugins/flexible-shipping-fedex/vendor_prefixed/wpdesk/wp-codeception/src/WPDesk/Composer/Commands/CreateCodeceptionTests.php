 ...
 */
class CreateCodeceptionTests extends \FedExVendor\WPDesk\Composer\Codeception\Commands\BaseCommand
{
    use SedTrait;
    /**
     * Configure command.
    ...
    {
        if (!\copy($source, $dest)) {
            throw new \FedExVendor\Composer\Downloader\FilesystemException($exceptionMessage);
        }
    }
    /**
