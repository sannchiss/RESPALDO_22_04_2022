...
if (\PHP_VERSION_ID > 50300) {
    ...
    if (!isset($plugin_init_factory)) {
        $plugin_init_factory = new \FedExVendor\WPDesk\Plugin\Flow\Initialization\Simple\SimpleFactory();
    }
    $bootstrap = new \FedExVendor\WPDesk\Plugin\Flow\PluginBootstrap(
        $plugin_version,
        null,
        // deprecated
        $plugin_name,
