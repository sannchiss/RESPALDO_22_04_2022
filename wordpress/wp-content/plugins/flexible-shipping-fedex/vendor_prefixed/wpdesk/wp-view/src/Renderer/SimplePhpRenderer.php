 ...
 */
class SimplePhpRenderer implements \FedExVendor\WPDesk\View\Renderer\Renderer
{
    /** @var Resolver */
    private $resolver;
    public function __construct(\FedExVendor\WPDesk\View\Resolver\Resolver $resolver)
    {
