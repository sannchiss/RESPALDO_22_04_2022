...
class FieldApiStatusAjax implements \FedExVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
     ...
     */
    public function __construct(\FedExVendor\WPDesk\AbstractShipping\ShippingService $shipping_service, \FedExVendor\WPDesk\AbstractShipping\Settings\SettingsValues $settings, \Psr\Log\LoggerInterface $logger)
    {
