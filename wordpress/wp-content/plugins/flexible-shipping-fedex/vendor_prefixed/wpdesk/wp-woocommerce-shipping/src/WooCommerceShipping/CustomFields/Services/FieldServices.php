 ...
 */
class FieldServices implements \FedExVendor\WPDesk\WooCommerceShipping\CustomFields\CustomField
{
    ...
    {
        $sanitizer = new \FedExVendor\WPDesk\WooCommerceShipping\CustomFields\Services\FieldServicesSanitizer();
