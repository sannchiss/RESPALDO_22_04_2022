...
\esc_html_e('Code', 'flexible-shipping-fedex');
?></th>
				<th class="service_name"><?php 
\esc_html_e('Name', 'flexible-shipping-fedex');
?></th>
				<th class="select">
					<label>
						<?php 
\esc_html_e('Enabled', 'flexible-shipping-fedex');
?>
						<input id="<?php 
echo \esc_attr($params['field_key']);
...
\esc_html_e('Drag and drop the services to control their display order. Confirm by clicking Save changes button below.', 'flexible-shipping-fedex');
?></span></th>
			</tr>
			</tfoot>
		</table>
