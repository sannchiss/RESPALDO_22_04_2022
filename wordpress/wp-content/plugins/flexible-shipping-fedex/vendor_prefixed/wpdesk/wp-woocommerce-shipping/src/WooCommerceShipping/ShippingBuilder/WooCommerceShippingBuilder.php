...
use FedExVendor\WPDesk\AbstractShipping\Shipment\Client;
...
class WooCommerceShippingBuilder
{
     ...
     */
    public function set_sender_address(\FedExVendor\WPDesk\WooCommerceShipping\ShippingBuilder\AddressProvider $sender_address)
    {
     ...
     */
    public function set_receiver_address(\FedExVendor\WPDesk\WooCommerceShipping\ShippingBuilder\AddressProvider $receiver_address)
    {
    ...
    protected function get_woocommerce_dimension_unit()
    {
        switch ($this->dimension_unit) {
            case 'mm':
                return \FedExVendor\WPDesk\AbstractShipping\Shipment\Dimensions::DIMENSION_UNIT_MM;
            case 'cm':
                return \FedExVendor\WPDesk\AbstractShipping\Shipment\Dimensions::DIMENSION_UNIT_CM;
            case 'm':
                return \FedExVendor\WPDesk\AbstractShipping\Shipment\Dimensions::DIMENSION_UNIT_M;
            case 'in':
                return \FedExVendor\WPDesk\AbstractShipping\Shipment\Dimensions::DIMENSION_UNIT_IN;
        }
    ...
    protected function get_woocommerce_weight_unit()
    {
        switch ($this->weight_unit) {
            case 'g':
                return \FedExVendor\WPDesk\AbstractShipping\Shipment\Weight::WEIGHT_UNIT_G;
            case 'kg':
                return \FedExVendor\WPDesk\AbstractShipping\Shipment\Weight::WEIGHT_UNIT_KG;
            case 'lb':
                return \FedExVendor\WPDesk\AbstractShipping\Shipment\Weight::WEIGHT_UNIT_LB;
        }
    ...
    {
        $weight = new \FedExVendor\WPDesk\AbstractShipping\Shipment\Weight();
    ...
    {
        $item = new \FedExVendor\WPDesk\AbstractShipping\Shipment\Item();
        ...
        $item->declared_value = new \FedExVendor\WPDesk\AbstractShipping\Rate\Money();
    ...
    {
        $dimension = new \FedExVendor\WPDesk\AbstractShipping\Shipment\Dimensions();
    ...
    {
        $shipping_package = new \FedExVendor\WPDesk\AbstractShipping\Shipment\Package();
        $package_weight = new \FedExVendor\WPDesk\AbstractShipping\Shipment\Weight();
    ...
    {
        $shipment = new \FedExVendor\WPDesk\AbstractShipping\Shipment\Shipment();
        $ship_from = new \FedExVendor\WPDesk\AbstractShipping\Shipment\Client();
        $ship_from->address = $this->sender_address->get_address();
        $ship_to = new \FedExVendor\WPDesk\AbstractShipping\Shipment\Client();
