...
trait RateWithRateMethodsTrait
{
    ...
    {
        return 'yes' === $this->get_option(\FedExVendor\WPDesk\WooCommerceShipping\CustomOrigin\CustomOriginFields::CUSTOM_ORIGIN, 'no');
    }
    /**
     ...
     */
    private function handle_rating_using_methods(\Psr\Log\LoggerInterface $logger, \FedExVendor\WPDesk\AbstractShipping\ShippingService $service, array $package, \FedExVendor\WPDesk\WooCommerceShipping\ShippingBuilder\WooCommerceShippingMetaDataBuilder $metadata_builder)
    {
