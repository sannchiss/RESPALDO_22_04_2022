...
class HelperRemoveInfo
{
    ...
    {
        return \FedExVendor\WPDesk_Basic_Requirement_Checker::is_wp_plugin_active($this->plugin_file);
    }
    /**
    ...
    {
        return \FedExVendor\WPDesk_Basic_Requirement_Checker::is_wp_plugin_installed($this->plugin_file);
    }
    /**
    ...
    public function show_deactivate_helper_notice()
    {
        ...
        new \FedExVendor\WPDesk\Notice\Notice(\sprintf(\__('We recommend to <a href="%s">deactivate and remove</a> the "WP Desk Helper" plugin as it is no longer required by WP Desk plugins', 'flexible-shipping-fedex'), $remove_url));
    }
    /**
    ...
    public function show_remove_helper_notice()
    {
        ...
        new \FedExVendor\WPDesk\Notice\Notice(\sprintf(\__('We recommend to <a href="%s">remove</a> the "WP Desk Helper" plugin as it is no longer required by WP Desk plugins', 'flexible-shipping-fedex'), $remove_url));
    }
}
