...
use FedExVendor\WPDesk\License\Page\LicensePage;
 ...
 */
class LicenseIntegration implements \FedExVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    /** @var LicensePage */
    ...
    {
        $plugin_registry = new \FedExVendor\WPDesk\License\InstalledPlugins();
        $this->license_page = new \FedExVendor\WPDesk\License\Page\LicensePage($plugin_registry);
