 ...
 */
class LibraryDebugPage implements \FedExVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    ...
    public function hooks()
    {
        \add_action('admin_menu', function () {
            ...
            \add_submenu_page($parent_slug, \__('Library report', 'flexible-shipping-fedex'), \__('Library report', 'flexible-shipping-fedex'), 'manage_options', 'wpdesk-helper-library-report', function () {
