...
namespace FedExVendor\WPDesk\Helper\Page;
 ...
 */
class SettingsPage implements \FedExVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    ...
    {
        \add_submenu_page('wpdesk-helper', \__('Settings', 'flexible-shipping-fedex'), \__('Settings', 'flexible-shipping-fedex'), 'manage_options', 'wpdesk-helper-settings', function () {
    ...
    private function handle_render_wpdesk_helper_settings()
    {
        ...
        <div class="wrap">
            <h1><?php 
        \_e('WP Desk Helper Settings', 'flexible-shipping-fedex');
        ?></h1>
