...
namespace FedExVendor\WPDesk\License\Changelog;

use ArrayObject;
use FedExVendor\WPDesk\License\Changelog\Parser\Line;
/**
 * Can parse changelog.
 *
...
class Parser
{
    ...
    private function get_lines()
    {
        ...
        return \array_map(function ($line) {
            return new \FedExVendor\WPDesk\License\Changelog\Parser\Line($line);
