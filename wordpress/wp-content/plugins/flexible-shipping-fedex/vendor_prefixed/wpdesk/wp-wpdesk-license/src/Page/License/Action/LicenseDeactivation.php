 ...
 */
class LicenseDeactivation implements \FedExVendor\WPDesk\License\Page\Action
{
    /**
    ...
    public function execute(array $plugin)
    {
        ...
        if ($activate_results['deactivated'] === \true) {
            ...
            \add_settings_error('wc_am_deactivate_text', 'deactivate_msg', \__('Plugin subscription deactivated. ', 'flexible-shipping-fedex') . "{$activate_results['activations_remaining']}.", 'updated');
            $deactivated = \true;
