...
class WPDesk_Helper_List_Table extends \WP_List_Table
{
    ...
    {
        echo \wpautop(\__('No WP Desk plugins found.', 'flexible-shipping-fedex'));
    }
    ...
    {
        $columns = ['product_name' => \__('Plugin', 'flexible-shipping-fedex'), 'product_status' => \__('Subscription Status', 'flexible-shipping-fedex'), 'product_license' => \__('Subscription Data', 'flexible-shipping-fedex')];
        return $columns;
    }
    ...
    {
        $status = \__('Deactivated', 'flexible-shipping-fedex');
        if ($item['activation_status'] == 'Activated') {
            $status = \__('Activated', 'flexible-shipping-fedex');
        }
        return $status;
    }
