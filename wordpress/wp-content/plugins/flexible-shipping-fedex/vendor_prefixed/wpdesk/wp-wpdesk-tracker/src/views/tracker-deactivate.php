...
<h2><?php 
echo \sprintf(\__('You are deactivating %s plugin.', 'flexible-shipping-fedex'), $plugin_name);
?></h2>
...
<div class="wpdesk_tracker_deactivate">
	<div class="body">
		...
		<div class="panel active" data-panel-id="reasons">
			<h4><strong><?php 
\_e(' If you have a moment, please let us know why you are deactivating plugin (anonymous feedback):', 'flexible-shipping-fedex');
?></strong></h4>
			<ul id="reasons-list">
                <li class="reason">
                    <label>
	            	<span>
                        ...
                        <span><?php 
\_e('The plugin suddenly stopped working', 'flexible-shipping-fedex');
?></span>
                    </label>
                </li>
                <li class="reason">
	            	...
	            	<span>
                        ...
                        <span><?php 
\_e('The plugin broke my site', 'flexible-shipping-fedex');
?></span>
                    </label>
                </li>
				<li class="reason has-input">
					<label>
						...
						<span><?php 
\_e('I found a better plugin', 'flexible-shipping-fedex');
?></span>
					</label>
					<div id="found_better_plugin" class="reason-input">
						<input type="text" name="better_plugin_name" placeholder="<?php 
\_e('What\'s the plugin\'s name?', 'flexible-shipping-fedex');
?>">
					</div>
				</li>
				<li class="reason">
	            	...
	            	<span>
						...
						<span><?php 
\_e('I only needed the plugin for a short period', 'flexible-shipping-fedex');
?></span>
					</label>
				</li>
				<li class="reason">
	            	...
	            	<span>
						...
						<span><?php 
\_e('I no longer need the plugin', 'flexible-shipping-fedex');
?></span>
					</label>
				</li>
				<li class="reason">
	            	...
	            	<span>
						...
						<span><?php 
\_e('It\'s a temporary deactivation. I\'m just debugging an issue.', 'flexible-shipping-fedex');
?></span>
					</label>
				</li>
				<li class="reason has-input">
	            	...
	            	<span>
						...
						<span><?php 
\_e('Other', 'flexible-shipping-fedex');
?></span>
					</label>
					<div id="other" class="reason-input">
						<input type="text" name="other" placeholder="<?php 
\_e('Kindly tell us the reason so we can improve', 'flexible-shipping-fedex');
?>">
					</div>
				</li>
			</ul>
...
\_e('Cancel', 'flexible-shipping-fedex');
?></a>
        <a href="#" class="button button-primary button-deactivate allow-deactivate"><?php 
\_e('Skip &amp; Deactivate', 'flexible-shipping-fedex');
?></a>
	</div>
</div>
...
\_e('Submit &amp; Deactivate', 'flexible-shipping-fedex');
?>' );
	})
