...
if (empty($notice_content)) {
    ...
    ?><br/>
            <?php 
    \_e('We need your help to improve <strong>WP Desk plugins</strong>, so they are more useful for you and the rest of <strong>30,000+ users</strong>. By collecting data on how you use our plugins, you will help us a lot. We will not collect any sensitive data, so you can feel safe.', 'flexible-shipping-fedex');
    ?>
            <a href="<?php 
    echo $terms_url;
    ?>" target="_blank"><?php 
...
\_e('Allow', 'flexible-shipping-fedex');
?></button>
    </p>
</div>
