...
class WPDA_Settings_Plugin extends WPDA_Settings
{
    protected function add_content()
    {
        ...
        ?>>Show menu and dashboard</option>
								<option value="dashboard" <?php 
        echo  ( 'dashboard' === $navigation ? 'selected' : '' ) ;
        ?>>Show dashboard only (hide sub menu item)</option>
								<option value="menu" <?php 
        echo  ( 'menu' === $navigation ? 'selected' : '' ) ;
        ?>>Show menu only (hide dashboard)</option>
							</select>
							<br/>
							<label>
        ...
        ?>>Show Project Templates on startup</option>
								...
								<span>(works only in dashboard only mode)</span>
							</label>
						</td>
					</tr>
					<tr>
        ...
        ?>
							...
							<span class="dashicons dashicons-yes"></span>
							<a href="<?php 
        echo  admin_url( 'options-general.php?page=wpdataaccess' ) ;
        ?>">
								<?php 
