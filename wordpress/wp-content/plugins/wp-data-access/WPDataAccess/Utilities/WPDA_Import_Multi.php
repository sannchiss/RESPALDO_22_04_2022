...
<?php echo __( 'Add a ; and a new line to the end of every SQL statement to run multiple SQL statements', 'wp-data-access' ); ?>."
									...
									<div id="import_tab-2" class="import_tab" style="display:none">
										<p class="wpda_list_indent">
											...
											echo __(
												...
												. __( 'Maximum supported file size is', 'wp-data-access' ) . ' <strong>' . @ini_get( 'upload_max_filesize' ) . '</strong>. ';
											?>
										</p>
										<p class="wpda_list_indent">
		...
		private function import_sql() {
			...
			<p class="wpda_list_indent">
				<?php
				echo '<strong>' . __( 'IMPORTANT', 'wp-data-access' ) . '</strong> &minus; ' .
					__( 'Add a ; and a new line to the end of every SQL statement to run multiple SQL statements', 'wp-data-access' ) . '.';
				?>
			</p>
			<?php
		}
