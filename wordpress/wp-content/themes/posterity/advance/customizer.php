...
function posterity_customizer_controls_js(){
	...
	$skt_params = array(
		...
		'google_fonts' => require get_template_directory() . '/advance/inc/google-fonts-json.php',
...
function posterity_customizer_preview_css(){
	...
	echo '<style type="text/css" media="all" id="user-custom-css">'.posterity_user_custom_css().'</style>';
