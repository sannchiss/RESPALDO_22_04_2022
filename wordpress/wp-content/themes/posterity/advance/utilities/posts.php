...
if(!function_exists( 'posterity_post_meta_data' )){
    ...
    function posterity_post_meta_data() {
        echo posterity_get_post_meta_data();
    }
}
            ...
            <div class="about-author comment"<?php posterity_schema_args('author_box'); ?>>
                <div class="comment-body">
                    <?php $author_ID = get_the_author_meta( 'ID' );
                        echo '<a href="'.esc_url( get_author_posts_url($author_ID) ).'" class="avatar"'.posterity_get_schema_args('url').'>'.get_avatar( $author_ID, 90 ).'</a>';
                        echo '<strong class="comment-author"><span class="author-name" '.posterity_get_schema_args('name').'>'.get_the_author().'</span>';
            ...
            if($is_prev || $is_next){
                ...
                if($is_prev){
                    ...
                    echo '<a href="'.esc_url( get_permalink($id) ).'" class="item prev">'
                         ...
                         .'<span class="image">'.posterity_make_post_image( $id, $image_sizes ).'</span>'
                         .'</a>';
                }
                if($is_next){
                    $id = $next_post->ID;
                    ...
                    if(post_password_required()){
                        ...
                        <div class="formatter">
                            ...
                            <div class="real-content">
                                ...
                                <?php echo posterity_password_form(); //escaped on creation  ?>
                            </div>
                        </div>
                        <?php
                    }
...
if(!function_exists('posterity_schema_args')){
    ...
    function posterity_schema_args( $for ) {
        echo posterity_get_schema_args( $for );
    }
}
