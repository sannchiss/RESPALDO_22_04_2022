                    ...
                    <div class="real-content">
                        ...
                        <div class="attachment-info">
                            ...
                            <span><a href="<?php
                                ...
                                echo esc_url(get_permalink( $post->post_parent )); ?>" title="<?php esc_attr( sprintf( esc_html__( 'Return to %s', 'posterity' ), get_the_title( $post->post_parent ) ) ); ?>" rel="gallery"><?php
                                /* translators: %s - title of parent post */
                                printf(  esc_html__( 'Return to %s', 'posterity' ), get_the_title( $post->post_parent ) );
                                ?></a></span>
                            <?php endif; ?>

                            <span><?php
                                /* translators: %1$s - author name in form of link */
                                printf(  esc_html__( 'By %1$s', 'posterity' ),
                            ...
                            printf( esc_html__( 'Published %1$s', 'posterity' ),
                            ...
                            if ( wp_attachment_is_image() ) {
                                ...
                                if( isset($metadata['width']) && isset($metadata['height']) ){
                                    ...
                                    printf( esc_html__( 'Full size is %s pixels', 'posterity' ),
                            ...
                            ?>
                            <?php edit_post_link( esc_html__( 'Edit', 'posterity' ), '' ); ?>
                        </div>
